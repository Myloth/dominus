...
class Hero extends Character
{
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="App\Entity\Statistics\AttributeValue", mappedBy="hero")
     */
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="App\Entity\Character\HeroGear", mappedBy="hero")
     */
    protected $equipment;
