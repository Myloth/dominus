...
class HeroClassTemplate
{
     ...
     * @var HeroRole
     *
     * @ORM\ManyToOne(targetEntity="Dominus\ModelBundle\Entity\Character\HeroRole")
     ...
     *
     * @ORM\OneToMany(
     *     targetEntity="Dominus\ModelBundle\Entity\Character\HeroClassTemplateAttributeValue",
