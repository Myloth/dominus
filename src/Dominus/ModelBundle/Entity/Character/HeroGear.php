...
class HeroGear
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Dominus\ModelBundle\Entity\Character\Hero")
     * @ORM\JoinColumn(name="hero_id", referencedColumnName="id")
     */
    protected $hero;

    /**
     * @ORM\ManyToOne(targetEntity="Dominus\ModelBundle\Entity\Gear\Gear")
     * @ORM\JoinColumn(name="gear_id", referencedColumnName="id")
     */
    protected $gear;

    /**
     * @ORM\ManyToOne(targetEntity="Dominus\ModelBundle\Entity\Statistics\BodyPart")
